...
<table id="table_96AEBFF29F3D40CAA859133B22756B0C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Debugger affiche désormais les réponses d’AAM. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Correction d’un problème en raison duquel le Debugger continuait à remplacer les codes intégrés même lorsque la fenêtre de Debugger était fermée.
...
<table id="table_9AC6DE90AF4345DFA707BFBA1E58C328"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dans l’onglet Outils, vous pouvez insérer Launch de façon dynamique sur une page afin de tester quelque chose sur une page sur laquelle Launch n’est pas installé. </p> </td> 
  </tr> 
  <tr> 
...
* Correction d’un problème en raison duquel Debugger injectait _satellite sur chaque page.
...
<table id="table_8FDED5A7B7F7430A88AE441336F9C714"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Mise à jour du lien d’aide dans le pied de page vers <a href="https://docs.adobe.com/content/help/fr-FR/debugger/using/experience-cloud-debugger.html" format="https" scope="external"> https://docs.adobe.com/content/help/en/debugger/using/experience-cloud-debugger.html</a> </p> </td> 
  </tr> 
 </tbody> 
</table>
