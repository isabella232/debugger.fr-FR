...
1. Use [Adobe Experience Platform Launch](https://docs.adobe.com/content/help/fr-FR/launch/using/overview.html) or [DTM](https://docs.adobe.com/content/help/fr-FR/dtm/using/dtm-home.html) to insert code that activates [Adobe Experience Cloud](https://docs.adobe.com/content/help/fr-FR/experience-cloud/user-guides/home.html) solutions on your pages.
...
* **Lancement de la plate-forme :** déterminer la propriété, l’environnement et la génération qui sont déployés sur une page ;
